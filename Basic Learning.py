...
os.getcwd()
## set working directory
path = 'C:\\Users\\kammittal\\Desktop\\6. Technical Toolkit\\1. Python + ML\\2. Python Training Material'
os.chdir(path)
# 1) Import the dataset using pandas.
tips = pd.read_csv(r".\tips.csv")

# 2) Answer the following questions using summary statistics and grouped analyses 
# (no linear modeling yet)
# a. Examine the dataset first, looking at the distribution of all variables 
# (frequency tables for categorical variables 
# and mean/quantiles for continuous)
tips.describe()
...
tips_lm1=smf.ols('tip_pcn~total_bill+C(smoker)', data=tips).fit() #Specify C for Categorical
